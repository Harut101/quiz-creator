//{component QuizList} GET LIST QUIZES
export const START_GET_QUIZES = 'START_GET_QUIZES';
export const GET_QUIZES_SUCCESS = 'GET_QUIZES_SUCCESS';
export const GET_QUIZES_FAIL = 'GET_QUIZES_FAIL'

//{component Quiz} GET QUIZES
export const START_GET_QUIZ = 'START_GET_QUIZ';
export const GET_QUIZ_SUCCESS = 'GET_QUIZ_SUCCESS';
export const GET_QUIZ_FAIL = 'GET_QUIZ_FAIL';


//{component Quiz} ANSWER STATE
export const RIGTH_ANSWER = 'RIGTH_ANSWER';
export const WRONG_ANSWER = 'WRONG_ANSWER';
export const NEXT_QUESTION = 'NEXT_QUESTION';
export const REPET_GAME = 'REPET_GAME';
